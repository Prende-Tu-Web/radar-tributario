...
// El campo `service.icon` en Sanity existe pero está vacío, así que el
// mapeo vive acá por slug. Si más adelante cargan el campo real en Sanity,
// basta con leer `service.icon` en vez de este mapa.
